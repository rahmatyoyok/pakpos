	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          <span class="navbar-brand"><strong style="font-family: verdana; margin-left: 510px; text-align: center">PDS - Pak POS</strong></span>
...
<?php 
	...
	<div class="container-fluid" style="margin-top: 30px">
      ...
      <div class="row-fluid">
		...
		<form action="<?php echo site_url('Signin/do_login'); ?>" method="post">
